  ...
  head: () => ({
    meta: [
      { title: "Política de privacidade — inTermo" },
      {
        name: "description",
        content:
          "Como a inTermo coleta, usa e protege seus dados pessoais conforme a Lei Geral de Proteção de Dados (LGPD).",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="prose prose-sm dark:prose-invert mt-8 max-w-none space-y-4 text-foreground/90">
          ...
          <p>
            Coletamos dados de cadastro (empresa, contato, CNPJ), dados operacionais (contratos,
            clientes) e dados de uso da plataforma.
          </p>
          <h2 className="text-lg font-semibold">Como usamos</h2>
          <p>
            Os dados são usados para operar o serviço, gerar contratos e notas fiscais, prestar
            suporte e melhorar a plataforma.
          </p>
